...
public class LikeReviewDto {
    ...
    @Builder
    public LikeReviewDto(Long reviewId, String storeName, String address, String nickname, double grade, Long likeReviewCount, double avgGrade, String content, Boolean likeStatus) {
